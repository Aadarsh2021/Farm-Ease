                            ...
                            {authMethod === "email" ? (
                                <form onSubmit={handleEmailSignup} className="space-y-4 pt-2">
                                    <div className="space-y-4">
                                        <div className="relative">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-10 p-3 bg-gray-50 border border-gray-100 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition-all"
                                    ...
                                    <button
                                        type="submit"
                                        disabled={loading}
                                        className="w-full bg-green-600 hover:bg-green-700 text-white font-bold p-4 rounded-xl transition-all shadow-lg active:scale-[0.98] disabled:opacity-70 mt-4"
                                    >
                                    ...
                                    {!otpSent ? (
                                        <form onSubmit={handleSendOTP} className="space-y-4">
                                            <div className="flex gap-2">
                                                ...
                                                <input
                                                    ...
                                                    className="flex-1 p-3 bg-gray-50 border border-gray-100 rounded-xl focus:ring-2 focus:ring-green-500 outline-none"
                                            ...
                                            <button
                                                type="submit"
                                                disabled={loading}
                                                className="w-full bg-green-600 hover:bg-green-700 text-white font-bold p-4 rounded-xl transition-all shadow-lg disabled:opacity-70"
                                            >
                                        ...
                                        <form onSubmit={handleVerifyOTP} className="space-y-4">
                                            <input
                                                ...
                                                className="w-full p-4 bg-gray-50 border border-gray-100 rounded-xl focus:ring-2 focus:ring-green-500 outline-none text-center text-2xl tracking-[0.5em] font-mono font-bold"
                                                placeholder="000000"
                                                maxLength={6}
                                            />
                                            <button
