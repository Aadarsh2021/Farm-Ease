...
export default function LoginPage() {
    ...
    useAuth(); // Ensures auth state is tracked globally
    ...
    const [pendingRoleSelection, setPendingRoleSelection] = useState<import("firebase/auth").User | null>(null);
    ...
    const syncNewUserToSupabase = async (user: import("firebase/auth").User, userRole: string) => {
    ...
    const checkExistingOrPromptRole = async (user: import("firebase/auth").User) => {
    ...
    const handleSendOTP = async (e: React.FormEvent) => {
        ...
        setLoading(true);
        try {
            // Clear old verifier if exists to avoid reuse errors
    ...
    // --- FINALIZE REGISTRATION FOR NEW SOCIAL USERS ---
            ...
            <div className="bg-white rounded-3xl shadow-xl overflow-hidden w-full max-w-4xl flex flex-col md:flex-row-reverse">
                ...
                <div className="md:w-1/2 bg-emerald-600 p-10 text-white flex flex-col justify-between relative overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col items-end text-right">
                        <Link href="/" className="flex items-center gap-2 mb-12 flex-row-reverse">
                ...
                <div className="md:w-1/2 p-8 lg:p-12 flex flex-col">
                    ...
                    {/* Pending Role Selection (Post-Google/Phone Registration) */}
                                ...
                                <form onSubmit={handleEmailLogin} className="space-y-4 pt-2">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full p-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:outline-none text-sm"
                                    ...
                                    <button
                                        type="submit"
                                        disabled={loading}
                                        className="w-full bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-medium p-3 rounded-lg transition-all flex items-center justify-center mt-2 disabled:opacity-70"
                                    >
                                ...
                                <div className="space-y-4 pt-2">
                                    {!otpSent ? (
                                        <form onSubmit={handleSendOTP} className="space-y-4">
                                            <div>
                                                ...
                                                <div className="flex gap-2">
                                                    <span className="flex items-center px-3 bg-gray-100 border border-gray-200 rounded-lg text-sm text-gray-600 font-medium">+91</span>
                                                    <input
                                                        id="phone"
                                                        type="tel"
                                                        autoComplete="tel"
                                                        ...
                                                        className="flex-1 p-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:outline-none text-sm"
                                            ...
                                            <button
                                                type="submit"
                                                disabled={loading}
                                                className="w-full bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-medium p-3 rounded-lg transition-all disabled:opacity-70"
                                            >
                                        ...
                                        <form onSubmit={handleVerifyOTP} className="space-y-4">
                                            ...
                                            <div>
                                                <label className="block text-xs font-medium text-gray-700 mb-1" htmlFor="otp">Enter 6-digit OTP</label>
                                                <input
                                                    id="otp"
                                                    type="text"
                                                    ...
                                                    className="w-full p-3 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:outline-none text-center text-xl tracking-[0.5em] font-mono"
                                                    placeholder="------"
                                                    maxLength={6}
                                                />
                                            </div>
