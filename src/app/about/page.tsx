        ...
        <div className="bg-white">
            ...
            <section className="py-20 bg-gradient-to-r from-green-600 to-emerald-500">
                <div className="max-w-4xl mx-auto text-center px-4">
                    <h2 className="text-4xl font-extrabold text-white mb-4">Ready to Join Farm-Ease?</h2>
                    <p className="text-green-100 text-lg mb-8 max-w-xl mx-auto">Whether you&apos;re a farmer, seller, or consumer — there&apos;s a place for you on our platform.</p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link href="/signup" className="bg-white text-green-700 font-bold px-8 py-4 rounded-full hover:bg-green-50 transition-all shadow-lg flex items-center justify-center gap-2">
                            Get Started Free <ArrowRight size={18} />
                        </Link>
                        <Link href="/market" className="text-white border-2 border-white/40 font-bold px-8 py-4 rounded-full hover:bg-white/10 transition-all flex items-center justify-center gap-2">
                            Browse Marketplace
                        </Link>
                    </div>
                </div>
